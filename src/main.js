...
const COMPONENTS = {
  // Base
  'base-component': () => import('./components/base/Component.js'),

  // Layout
  'lc-layout': () => import('./components/layouts/lc-layout.js'),
  'lc-region': () => import('./components/layouts/lc-region.js'),
  'lc-grid': () => import('./components/layouts/lc-grid.js'),
  'lc-block': () => import('./components/layouts/lc-block.js'),
  ...
  'lc-alert': () => import('./components/atomic/lc-alert.js'),
  'lc-badge': () => import('./components/atomic/lc-badge.js'),

  // Forms
  'lc-input': () => import('./components/forms/lc-input.js'),
  'lc-textbox': () => import('./components/forms/lc-textbox.js'),
  'lc-select': () => import('./components/forms/lc-select.js'),
  'lc-check': () => import('./components/forms/lc-check.js'),
  ...
  'lc-history': () => import('./components/navigation/lc-history.js'),
  'lc-controls': () => import('./components/navigation/lc-controls.js'),
  'lc-navbar': () => import('./components/navigation/lc-navbar.js'),
...
class ProgressiveEnhancement {
  ...
  setupThemeToggle() {
    ...
    themeManager.addListener((event, _data) => {
